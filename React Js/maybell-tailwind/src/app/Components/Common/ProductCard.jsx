...
export default function ProductCard({ product }) {
    ...
    const cartItems = useDispatch();   // Executable Funtion
        ...
        <>
            <div class="flex flex-col">
                <div class="relative flex">
                    ...
                    >
                        <Link href="/product-details/tshirt">
                            <span
                ...
                <div>
                    ...
                    <div>
                        <button onClick={ () => cartItems(addToCart(product))  } class="my-5 h-10 w-full bg-violet-900 text-white cursor-pointer">
                            Add to cart
                        </button>
                    </div>
                </div>
